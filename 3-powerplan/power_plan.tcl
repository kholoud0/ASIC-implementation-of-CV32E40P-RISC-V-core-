...
#### CREATE PG VIAS
create_pg_vias -to_layers M6 -from_layers M1 -via_masters PG_VIA_4x1 -nets VDD
create_pg_vias -to_layers M6 -from_layers M1 -via_masters PG_VIA_4x1 -nets VSS
...
save_block -as ${DESIGN}_3_after_pns_fixed
